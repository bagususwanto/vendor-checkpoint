...
[ops_checkin_entry_current_status_df],
[ops_checkin_entry_submission_time_df],
[ops_checkin_entry_updated_at_df];
ALTER TABLE [dbo].[ops_checkin_entry] ADD CONSTRAINT [ops_checkin_entry_created_at_df] DEFAULT CURRENT_TIMESTAMP FOR [created_at], CONSTRAINT [ops_checkin_entry_current_status_df] DEFAULT 'WAITING' FOR [current_status], CONSTRAINT [ops_checkin_entry_submission_time_df] DEFAULT CURRENT_TIMESTAMP FOR [submission_time], CONSTRAINT [ops_checkin_entry_updated_at_df] DEFAULT CURRENT_TIMESTAMP FOR [updated_at];
...
-- AlterTable
ALTER TABLE [dbo].[ops_performance_adjustment] DROP CONSTRAINT [ops_performance_adjustment_created_at_df],
[ops_performance_adjustment_updated_at_df];
ALTER TABLE [dbo].[ops_performance_adjustment] ADD CONSTRAINT [ops_performance_adjustment_created_at_df] DEFAULT CURRENT_TIMESTAMP FOR [created_at], CONSTRAINT [ops_performance_adjustment_updated_at_df] DEFAULT CURRENT_TIMESTAMP FOR [updated_at];
