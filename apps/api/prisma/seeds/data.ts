...
export const SYSTEM_CONFIGS = [
  ...
  },
  {
    ...
    config_value: 'Waiting Verification',
    config_type: 'STRING',
    description: 'Status waiting verification in Display',
    created_at: new Date(),
    updated_at: new Date(),
  },
  {
    config_key: 'DEFAULT_STATUS_DISETUJUI_DISPLAY_TEXT',
    config_value: 'Processing',
    config_type: 'STRING',
    description: 'Status approved in Display',
    created_at: new Date(),
    updated_at: new Date(),
  },
  {
    ...
    config_type: 'STRING',
    description: 'Status active/accepted in Display',
    created_at: new Date(),
    updated_at: new Date(),
  },
  {
    config_key: 'DEFAULT_STATUS_DITOLAK_DISPLAY_TEXT',
    config_value: 'Rejected',
    config_type: 'STRING',
    description: 'Status rejected in Display',
    created_at: new Date(),
    updated_at: new Date(),
  },
  {
    ...
    config_type: 'STRING',
    description: 'Status completed in Display',
    created_at: new Date(),
    updated_at: new Date(),
  },
  {
    config_key: 'DEFAULT_STATUS_TERTAHAN_DISPLAY_TEXT',
    config_value: 'On Hold',
    config_type: 'STRING',
    description: 'Status on hold in Display',
    created_at: new Date(),
    updated_at: new Date(),
  },
];
...
export const MASTER_VENDOR_SCHEDULE = [
  {
    vendor_code: 250295,
    day_of_week: 1,
    rit: 1,
